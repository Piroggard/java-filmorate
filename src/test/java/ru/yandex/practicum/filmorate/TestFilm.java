...
public class TestFilm {
    ...
    @Test
    void createAnObject() {
        Film film = new Film("Naim", "description", LocalDate.of(2000, 12, 25), 2);
    ...
    void createAnObjectWrongReleaseDate() {
        Film film = new Film("Naim", "description", LocalDate.of(1800, 12, 25), 2);
    ...
    void createAnObjectEmptyName() {
        Film film = new Film("", "description", LocalDate.of(1995, 12, 25), 2);
        assertThrows(ValidationException.class, () -> filmController.putFilm(film), "No name");
    }

    @Test
    void createAnObjectMaximumDescription201() {
        Film film = new Film("Naim", "ааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааа" + "аааааааааааааааааааааааааааааaааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааа" + "ааааааааааааааааааааааааaааaaaaaaaaaа", LocalDate.of(1995, 12, 25), 2);
    ...
    void createAnObjectMaximumDescription200() {
        Film film = new Film("Naim", "ааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааа" + "аааааааааааааааааааааааааааааaааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааааа" + "ааааааааааааааааааааааааааaaaaaaaaaа", LocalDate.of(1995, 12, 25), 2);
    ...
    void createAnObjectduration1m() {
        Film film = new Film("Naim", "description", LocalDate.of(1995, 12, 25), 1);
        filmController.postFilm(film);
    ...
    void createAnObjectdurationNullm() {
        Film film = new Film("Naim", "description", LocalDate.of(1995, 12, 25), 0);
    ...
    void createAnObjectPut() {
        Film film = new Film("Naim", "description", LocalDate.of(2000, 12, 25), 2);
        filmController.postFilm(film);
        Film film1 = new Film(1, "Naim", "description", LocalDate.of(2000, 12, 25), 2);
